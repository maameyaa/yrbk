...
$(document).ready(function(){
        ...
        for(i=1; i<5; i++ ){
          ...
          $("#photos").append( "<div class='col-6 col-lg-3' style='margin-bottom: 30px;'><a data-lightbox='image' href='"+ folder + i + '.jpg'+"' ><img alt='100%x180' src='"+ folder + i + '.jpg'+ "' class='img-thumbnail' style='height: 100%; width: 100%; display: block;'></a></div>" );
        }
// $.ajax({
//     url : folder,
